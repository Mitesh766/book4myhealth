...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      {/* Sidebar Panel */}
      <div
        className={`fixed top-0 flex flex-col justify-between left-0 h-full w-80 bg-black border-r border-gray-800 z-40 transform transition-all duration-300 ease-out ${
          isOpen
      ...
      >
              ...
              {options.map((option, index) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full cursor-pointer flex items-center space-x-4 p-4 rounded-xl transition-all duration-200 group relative ${
                      isActive
        ...
        {/* Sidebar Footer */}
        <div className="p-4 border-t border-gray-800 bg-gradient-to-r from-gray-900/30 to-black  bottom-0">
